...
mixer.music.play()
#//? ігрові змінні і прапорці для персонажів
life = 5
lost = 0
score = 0
numshot = 5
...
uwin = font1.render("Ви виграли!",1,(55,255,55))
ulose = font1.render("Ви програли!",1,(255,0,0))
pressR = font2.render("Нажміть 'F' для перезапуску",1,(255,255,255))

#створи 2 спрайти та розмісти їх на сцені(Pov:стибзив свій код:)x3 )
...
def reoladcheck():
    ...
    if reltime == True:
        ...
        if now_time - last_time < 3:
            reolads = font2.render('Перезарядка, зачекайте будь ласка...',1,(150,0,0))
...
while game:
    ...
    if not finish:
        ...
        text_score = font2.render("Патрони: " +str(numshot),1,(255,255,255))
        ...
        text_lifes = font2.render('Життя: ' +str(life),1,(255,255,255))
        window.blit(text_lifes,(win_width - 120,20))
        


    #todo Обробка зіткнень
...
#
 #           if now_time - last_time < 3:
  #              reolad = font2.render('Reolading, please wait...',1,(150,0,0))
   #             window.blit(reolad(260,460))
    #        else:
     #           numshot = 5
      #          reltime = False'''
    # TODO умови програшу та виграшу
   ...
   # print("dsad") # * Я цією командую все перевіряю
